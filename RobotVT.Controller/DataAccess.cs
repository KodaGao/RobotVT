...
namespace RobotVT.Controller
{
    public class DataAccess
    {
        ...
        public void UpdateCameraSet(RobotVT.Model.S_D_CameraSet s_D_)
        {
            try
            {
                string _SqlScript = string.Format("UPDATE VT_NAME='{0}', VT_PASSWORD='{1}', VT_IP='{2}', VT_PORT='{3}' From S_D_CameraSet WHERE VT_ID ='{4}';", s_D_.VT_NAME, s_D_.VT_PASSWORD, s_D_.VT_IP, s_D_.VT_PORT, s_D_.VT_ID);
