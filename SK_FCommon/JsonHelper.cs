...
namespace SK_FCommon
{
    public class JsonHepler
    {
        ...
        /// 序列化集合对象
        /// </summary>
        public string JsonSerializerByArrayData<T>(T[] tArray)
        {
        ...
        /// 序列化单个对象
        /// </summary>
        public string JsonSerializerBySingleData<T>(T t)
        {
            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(T));
            MemoryStream ms = new MemoryStream();
        ...
        /// 反序列化单个对象
        /// </summary> 
        public T JsonDeserializeBySingleData<T>(string jsonString)
        {
